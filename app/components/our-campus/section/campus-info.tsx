...
export default function CampusInfoSection({ onNavigate }: CampusInfoSectionProps) {
    ...
    <section className='w-full py-12 md:py-24 bg-white relative overflow-hidden'>
      ...
      <div className='container mx-auto px-4 md:px-8 relative z-10 space-y-16 md:space-y-24'>
        ...
        >
                ...
                <button
                  ...
                  className={cn(
                    ...
                    activePreschool === index
                      ...
                      : 'bg-transparent text-[#1e5338] hover:bg-white'
                  )}
                >
                  {campus.shortName}
                </button>
          ...
          <CampusInfoSplit 
            campus={preschools[activePreschool]} 
...
function CampusInfoSplit({ campus, onWebsiteClick }: CampusInfoSplitProps) {
  return (
    <div className='grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 bg-white rounded-3xl overflow-hidden border border-gray-200 shadow-[0_10px_50px_rgba(0,0,0,0.08)]'>
      ...
      <div className='p-8 md:p-10 lg:p-12 flex flex-col justify-center'>
        {/* Header */}
          <div className='mb-4 w-20 h-1 bg-[#faba1e] rounded-full' />

        <div className=''>
          <h3 className='text-2xl md:text-3xl lg:text-4xl font-black text-[#1e5338] mb-3 leading-tight'>
            {campus.name}
          </h3>
        </div>
        ...
        <div className='space-y-5 mb-8'>
          ...
          <div className='flex items-start gap-4'>
            <div className='flex-shrink-0 w-10 h-10 bg-[#faba1e]/10 rounded-full flex items-center justify-center'>
              <MapPin className='w-5 h-5 text-[#1e5338]' />
            </div>
            <div>
          ...
          <div className='flex items-start gap-4'>
            <div className='flex-shrink-0 w-10 h-10 bg-[#faba1e]/10 rounded-full flex items-center justify-center'>
              <Phone className='w-5 h-5 text-[#1e5338]' />
            </div>
            <div>
              ...
              <a 
                ...
                className='text-base md:text-lg text-[#1e5338] hover:text-[#faba1e] transition-colors font-semibold'
              >
                {campus.phone}
              </a>
            </div>
          ...
          <div className='flex items-start gap-4'>
            <div className='flex-shrink-0 w-10 h-10 bg-[#faba1e]/10 rounded-full flex items-center justify-center'>
              <Mail className='w-5 h-5 text-[#1e5338]' />
            </div>
            <div>
              <p className='text-xs md:text-sm text-gray-500 uppercase tracking-wide mb-1 font-bold'>Email</p>
              <a 
                href={`mailto:${campus.email}`}
                className='text-base md:text-lg text-[#1e5338] hover:text-[#faba1e] transition-colors font-medium'
              >
                {campus.email}
              </a>
            </div>
        ...
        <div className='flex flex-col sm:flex-row gap-4'>
          <a
            target='_blank'
            href={campus.website}
            className='flex-1 flex items-center justify-center gap-3 px-8 py-4 bg-[#faba1e] hover:bg-[#e5a812] text-[#1e5338] font-bold text-base rounded-full transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-xl'
          >
          ...
          <a
            ...
            className='flex items-center justify-center gap-3 px-8 py-4 bg-[#1e5338] hover:bg-[#163d2a] text-white font-bold text-base rounded-full transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-xl'
          >
