      ...
      <div className='container mx-auto px-4 md:px-8 relative z-10'>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6'>
          {archiveReports.map((report, index) => (
            ...
            >
              <div className='group bg-white rounded-xl p-4 border border-gray-200 hover:border-lhbs-yellow/50 transition-all duration-300 hover:shadow-md flex items-center gap-4 cursor-pointer'
                onClick={() => handleDownload(report.pdfUrl)}>

                {/* Icon */}
                <div className='flex-shrink-0 w-10 h-10 bg-gray-100 rounded-lg flex items-center justify-center group-hover:bg-lhbs-yellow/10 transition-colors'>
                ...
                <div className='flex-1 min-w-0'>
                  ...
                  <h4 className='text-sm font-bold text-gray-700 truncate group-hover:text-lhbs-green transition-colors' title={report.title}>
                    {report.title}
                  </h4>
