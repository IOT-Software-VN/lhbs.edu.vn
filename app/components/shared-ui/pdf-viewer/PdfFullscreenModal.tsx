...
export default function PdfFullscreenModal({
    ...
    return (
        <Dialog open={isOpen} onOpenChange={onOpenChange}>
            <DialogContent showCloseButton={false} className="min-w-[100vw] h-[100dvh] w-screen p-0 border-0 rounded-none bg-black/60 backdrop-blur-md flex flex-col overflow-hidden focus:outline-none z-[9999]">
