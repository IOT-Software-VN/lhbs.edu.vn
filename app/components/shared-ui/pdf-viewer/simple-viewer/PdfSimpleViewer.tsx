...
export default function PdfSimpleViewer({ file, className, height = 300 }: PdfSimpleViewerProps) {
    ...
    return (
        <div className={cn("w-full bg-gray-50 border border-gray-100 rounded-lg overflow-hidden relative group", className)} style={{ height }}>
            <Document
                file={file}
            ...
            >
                <div className="flex flex-col items-center gap-4 py-4">
                    ...
                    {Array.from(new Array(numPages), (el, index) => (
                        <div key={`page_${index + 1}`} className="shadow-md bg-white w-[90%] transition-transform hover:scale-[1.02] duration-300">
                            <Page
                                pageNumber={index + 1}
