    ...
    `
      ...
      <div className='w-full px-4 md:px-10 py-14'>
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-16'>
          ...
          {/* Column 2: About LHBS */}
          <div>
            <h3 className=' text-xl text-[#fffae9] mb-6'>About LHBS</h3>
          ...
          <div>
            <h3 className=' text-xl text-[#fffae9] mb-6'>Our Programs</h3>
          ...
          <div>
            <h3 className=' text-xl text-[#fffae9] mb-6'>Connect With Us</h3>
  ...
  return (
    ...
    >
      ...
      >
        ...
        {platform === 'linkedin' && (
          <g>
            <path d='M15.375 17.5H12.25V27.5H15.375V17.5Z' fill='#fffae9' />
            <path
