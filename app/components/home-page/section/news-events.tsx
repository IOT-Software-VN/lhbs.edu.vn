  ...
  const newsEvents: NewsEvent[] = [
    {
      ...
      title:
        'Grade 7 Students Of Lac Hong Bilingual School Explore Local Education – Learning From Tradition, Growing With Pride In Dong Nai',
      excerpt:
        'Local Education – Learning from Tradition, Growing with Pride in Dong Nai As part of the Local Education Program, Grade 7 students of Lac...',
    ...
    },
    {
      ...
      excerpt:
        'Lac Hong Bilingual School Staff Enhance Knowledge and Professional Skills in Food Safety and Hygiene To ensure a safe, clean, and healthy learning environment,...',
    ...
    },
    {
      ...
      excerpt:
        'Career Orientation Program “Right Major – Bright Future” organized by the Department of Education & Training of Dong Nai Province',
  ...
  return (
    ...
    >
      ...
      <div className='relative overflow-hidden' style={{ aspectRatio: '16 / 9' }}>
        ...
        {tag && (
          <div className='absolute bottom-0 left-0 bg-[#227D46] px-4 py-1'>
            <span className=' text-xs text-white font-medium'>{tag}</span>
          </div>
        )}
      </div>
      ...
      <div className='p-5 md:p-6 flex flex-col grow'>
        ...
        {/* Headline */}
        <h3 className=' text-sm md:text-xl text-[#1a5336] mb-3 leading-tight'>{title}</h3>

        {/* Excerpt */}
        <p className=' text-sm text-[#1A1A1A99] mb-4 leading-relaxed line-clamp-3 grow'>{excerpt}</p>
