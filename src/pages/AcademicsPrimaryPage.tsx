      ...
      >
        ...
        <div className="relative w-full max-w-screen-xl mx-auto px-6 md:px-12 py-24 md:py-32">
          ...
          <div className="max-w-3xl">
            <p className="text-[#FABA1E] mb-4  uppercase tracking-wider">Grades 1-5 | Ages 6-11</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
              <div className="bg-white/10 backdrop-blur-sm p-6 border border-white/20">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <div className=" text-[#fffae9] text-2xl mb-1">1:15</div>
                    <div className=" text-[#fffae9]/80 text-sm">Max Class Size</div>
                  </div>
                </div>
              </div>
              <div className="bg-white/10 backdrop-blur-sm p-6 border border-white/20">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <div className=" text-[#fffae9] text-2xl mb-1">120+</div>
                    <div className=" text-[#fffae9]/80 text-sm">Teacher PD Hours/Year</div>
                  </div>
                </div>
              </div>
              <div className="bg-white/10 backdrop-blur-sm p-6 border border-white/20">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <div className=" text-[#fffae9] text-2xl mb-1">60 min</div>
                    <div className=" text-[#fffae9]/80 text-sm">Daily Reading Time</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="w-full max-w-screen-xl mx-auto px-6 md:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-[#fffae9] p-8 shadow-sm hover:shadow-md transition-shadow group">
              ...
              <h3 className=" text-[24px] font-bold text-[#1a5336] mb-3">Critical Thinking</h3>
            ...
            <div className="bg-[#fffae9] p-8 shadow-sm hover:shadow-md transition-shadow group">
              ...
              <h3 className=" text-[24px] font-bold text-[#1a5336] mb-3">Bilingual Fluency</h3>
              <p className=" text-[#1a5336]/70">
            ...
            <div className="bg-[#fffae9] p-8 shadow-sm hover:shadow-md transition-shadow group">
              ...
              <h3 className=" text-[24px] font-bold text-[#1a5336] mb-3">Creativity & Innovation</h3>
              <p className=" text-[#1a5336]/70">
            ...
            <div className="bg-[#fffae9] p-8 shadow-sm hover:shadow-md transition-shadow group">
              ...
              <h3 className=" text-[24px] font-bold text-[#1a5336] mb-3">Collaboration Skills</h3>
              <p className=" text-[#1a5336]/70">
            ...
            <div className="bg-[#fffae9] p-8 shadow-sm hover:shadow-md transition-shadow group">
              ...
              <h3 className=" text-[24px] font-bold text-[#1a5336] mb-3">Character Development</h3>
              <p className=" text-[#1a5336]/70">
      ...
      <section className="bg-[#fffae9] py-24 md:py-32" id="curriculum">
        <div className="w-full max-w-screen-xl mx-auto px-6 md:px-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
              <h3 className=" text-[24px] font-bold text-[#1a5336] mb-6">Learning Goals & Methods</h3>
              
              <div className="space-y-6">
                <div className="bg-white p-6 border-l-4 border-[#FABA1E]">
                  <h4 className=" text-[#1a5336] mb-2">Core Academic Mastery</h4>
                ...
                <div className="bg-white p-6 border-l-4 border-[#FABA1E]">
                  <h4 className=" text-[#1a5336] mb-2">Inquiry-Based Learning</h4>
                  <p className=" text-[#1a5336]/70 text-sm">
                ...
                <div className="bg-white p-6 border-l-4 border-[#FABA1E]">
                  <h4 className=" text-[#1a5336] mb-2">Project-Based Learning</h4>
                  <p className=" text-[#1a5336]/70 text-sm">
                ...
                <div className="bg-white p-6 border-l-4 border-[#FABA1E]">
                  <h4 className=" text-[#1a5336] mb-2">Differentiated Instruction</h4>
                  <p className=" text-[#1a5336]/70 text-sm">
                  ...
                  <table className="w-full">
                    ...
                    <tbody>
                      <tr className="border-b border-[#1a5336]/20">
                        <td className="py-3  text-[#1a5336]/70">Literacy (English & Vietnamese)</td>
                        <td className="text-right py-3  text-[#1a5336]">10</td>
                      </tr>
                      <tr className="border-b border-[#1a5336]/20">
                      ...
                      <tr className="border-b border-[#1a5336]/20">
                        <td className="py-3  text-[#1a5336]/70">Science & STEAM</td>
                      ...
                      <tr className="border-b border-[#1a5336]/20">
                        <td className="py-3  text-[#1a5336]/70">Arts (Visual & Performing)</td>
                        <td className="text-right py-3  text-[#1a5336]">3</td>
                      </tr>
                      <tr className="border-b border-[#1a5336]/20">
              ...
              <div className="bg-white p-8 shadow-sm">
                ...
                <ul className="space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span className=" text-[#1a5336]/70">Formative assessments and exit tickets daily</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <ChevronRight className="w-5 h-5 text-[#FABA1E] flex-shrink-0 mt-0.5" />
                    <span className=" text-[#1a5336]/70">Standards-based report cards quarterly</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <ChevronRight className="w-5 h-5 text-[#FABA1E] flex-shrink-0 mt-0.5" />
                    <span className=" text-[#1a5336]/70">Parent-teacher conferences twice yearly</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <ChevronRight className="w-5 h-5 text-[#FABA1E] flex-shrink-0 mt-0.5" />
                    <span className=" text-[#1a5336]/70">Digital portfolios showcasing student work</span>
                  </li>
                </ul>
              </div>
        ...
        <div className="w-full max-w-screen-xl mx-auto px-6 md:px-12">
          ...
          <div className="space-y-12">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              ...
              {/* Content */}
              <div>
                <h3 className=" text-[24px] font-bold text-[#1a5336] mb-4">Teaching Excellence</h3>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              ...
              {/* Content */}
              <div>
                <h3 className=" text-[24px] font-bold text-[#1a5336] mb-4">Specialized Learning Spaces</h3>
                <ul className="space-y-4">
                  <li className="flex items-start gap-3">
                    <ChevronRight className="w-5 h-5 text-[#FABA1E] flex-shrink-0 mt-1" />
                    <div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              ...
              {/* Content */}
              <div>
                <h3 className=" text-[24px] font-bold text-[#1a5336] mb-4">Safety & Communication</h3>
                <ul className="space-y-4">
                  <li className="flex items-start gap-3">
                    <ChevronRight className="w-5 h-5 text-[#FABA1E] flex-shrink-0 mt-1" />
                    <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white p-6 shadow-sm">
              ...
              <div className="flex items-center gap-3 mb-3">
                ...
                <h3 className=" text-[24px] font-bold text-[#1a5336]">STEM & Robotics</h3>
              </div>
              <ul className="space-y-2">
                <li className="flex items-start gap-2">
                  <ChevronRight className="w-4 h-4 text-[#FABA1E] flex-shrink-0 mt-1" />
                  <span className=" text-[#1a5336]/70 text-sm">Coding and programming fundamentals</span>
                </li>
                <li className="flex items-start gap-2">
                  <ChevronRight className="w-4 h-4 text-[#FABA1E] flex-shrink-0 mt-1" />
                  <span className=" text-[#1a5336]/70 text-sm">Robotics competitions and challenges</span>
                </li>
                <li className="flex items-start gap-2">
                  <ChevronRight className="w-4 h-4 text-[#FABA1E] flex-shrink-0 mt-1" />
                  <span className=" text-[#1a5336]/70 text-sm">Engineering design projects</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white p-6 shadow-sm">
              ...
              <div className="flex items-center gap-3 mb-3">
                ...
                <h3 className=" text-[24px] font-bold text-[#1a5336]">Visual & Performing Arts</h3>
              </div>
              <ul className="space-y-2">
                <li className="flex items-start gap-2">
                  <ChevronRight className="w-4 h-4 text-[#FABA1E] flex-shrink-0 mt-1" />
                  <span className=" text-[#1a5336]/70 text-sm">Choir, band, and music ensembles</span>
                </li>
                <li className="flex items-start gap-2">
                  <ChevronRight className="w-4 h-4 text-[#FABA1E] flex-shrink-0 mt-1" />
                  <span className=" text-[#1a5336]/70 text-sm">Drama productions and public speaking</span>
                </li>
                <li className="flex items-start gap-2">
                  <ChevronRight className="w-4 h-4 text-[#FABA1E] flex-shrink-0 mt-1" />
                  <span className=" text-[#1a5336]/70 text-sm">Visual arts studio and exhibitions</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white p-6 shadow-sm">
              ...
              <div className="flex items-center gap-3 mb-3">
                ...
                <h3 className=" text-[24px] font-bold text-[#1a5336]">Sports & Athletics</h3>
              </div>
              <ul className="space-y-2">
                <li className="flex items-start gap-2">
                  <ChevronRight className="w-4 h-4 text-[#FABA1E] flex-shrink-0 mt-1" />
                  <span className=" text-[#1a5336]/70 text-sm">Soccer, basketball, and volleyball teams</span>
                </li>
                <li className="flex items-start gap-2">
                  <ChevronRight className="w-4 h-4 text-[#FABA1E] flex-shrink-0 mt-1" />
                  <span className=" text-[#1a5336]/70 text-sm">Swimming and martial arts programs</span>
                </li>
                <li className="flex items-start gap-2">
                  <ChevronRight className="w-4 h-4 text-[#FABA1E] flex-shrink-0 mt-1" />
                  <span className=" text-[#1a5336]/70 text-sm">Inter-school competitions</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white p-6 shadow-sm">
              ...
              <div className="flex items-center gap-3 mb-3">
                ...
                <h3 className=" text-[24px] font-bold text-[#1a5336]">Reading & Languages</h3>
              </div>
              <ul className="space-y-2">
                <li className="flex items-start gap-2">
                  <ChevronRight className="w-4 h-4 text-[#FABA1E] flex-shrink-0 mt-1" />
                  <span className=" text-[#1a5336]/70 text-sm">Book clubs and reading challenges</span>
                </li>
                <li className="flex items-start gap-2">
                  <ChevronRight className="w-4 h-4 text-[#FABA1E] flex-shrink-0 mt-1" />
                  <span className=" text-[#1a5336]/70 text-sm">Creative writing workshops</span>
                </li>
                <li className="flex items-start gap-2">
                  <ChevronRight className="w-4 h-4 text-[#FABA1E] flex-shrink-0 mt-1" />
                  <span className=" text-[#1a5336]/70 text-sm">Additional language options (Mandarin, French)</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white p-6 shadow-sm">
              ...
              <div className="flex items-center gap-3 mb-3">
                ...
                <h3 className=" text-[24px] font-bold text-[#1a5336]">Field Trips & Service</h3>
              </div>
              <ul className="space-y-2">
                <li className="flex items-start gap-2">
                  <ChevronRight className="w-4 h-4 text-[#FABA1E] flex-shrink-0 mt-1" />
                  <span className=" text-[#1a5336]/70 text-sm">Monthly trips to museums, farms, cultural sites</span>
                </li>
                <li className="flex items-start gap-2">
                  <ChevronRight className="w-4 h-4 text-[#FABA1E] flex-shrink-0 mt-1" />
                  <span className=" text-[#1a5336]/70 text-sm">Community service projects</span>
                </li>
                <li className="flex items-start gap-2">
                  <ChevronRight className="w-4 h-4 text-[#FABA1E] flex-shrink-0 mt-1" />
                  <span className=" text-[#1a5336]/70 text-sm">Grade 5 residential learning camp</span>
                </li>
              </ul>
            </div>
          </div>
      ...
      <section className="bg-white py-24 md:py-32" id="support">
        <div className="w-full max-w-screen-xl mx-auto px-6 md:px-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <ul className="space-y-2">
                    <li className="flex items-start gap-2">
                      <ChevronRight className="w-4 h-4 text-[#FABA1E] flex-shrink-0 mt-1" />
                      <span className=" text-[#1a5336]/70 text-sm">Pull-out sessions 3-5 times weekly</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <ChevronRight className="w-4 h-4 text-[#FABA1E] flex-shrink-0 mt-1" />
                      <span className=" text-[#1a5336]/70 text-sm">Scaffolded instruction in content areas</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <ChevronRight className="w-4 h-4 text-[#FABA1E] flex-shrink-0 mt-1" />
                      <span className=" text-[#1a5336]/70 text-sm">Progress monitoring with WIDA assessments</span>
                    </li>
                  </ul>
                </div>

                <div>
                  <h4 className=" text-[#1a5336] mb-3">RTI (Response to Intervention)</h4>
                  <p className=" text-[#1a5336]/70 mb-3">
                  ...
                  <ul className="space-y-2">
                    <li className="flex items-start gap-2">
                      <ChevronRight className="w-4 h-4 text-[#FABA1E] flex-shrink-0 mt-1" />
                      <span className=" text-[#1a5336]/70 text-sm">Reading and math intervention specialists</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <ChevronRight className="w-4 h-4 text-[#FABA1E] flex-shrink-0 mt-1" />
                      <span className=" text-[#1a5336]/70 text-sm">Small group targeted instruction</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <ChevronRight className="w-4 h-4 text-[#FABA1E] flex-shrink-0 mt-1" />
                      <span className=" text-[#1a5336]/70 text-sm">Referrals to specialists when needed</span>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div className="bg-[#fffae9] p-8">
              <h3 className=" text-[24px] font-bold text-[#1a5336] mb-6">Enrichment & Wellbeing</h3>
              
              <div className="space-y-6">
                <div>
                  <h4 className=" text-[#1a5336] mb-3">Gifted & Talented Enrichment</h4>
                  <p className=" text-[#1a5336]/70 mb-3">
                  ...
                  <ul className="space-y-2">
                    <li className="flex items-start gap-2">
                      <ChevronRight className="w-4 h-4 text-[#FABA1E] flex-shrink-0 mt-1" />
                      <span className=" text-[#1a5336]/70 text-sm">Differentiated curriculum and extension projects</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <ChevronRight className="w-4 h-4 text-[#FABA1E] flex-shrink-0 mt-1" />
                      <span className=" text-[#1a5336]/70 text-sm">Acceleration options in math and language arts</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <ChevronRight className="w-4 h-4 text-[#FABA1E] flex-shrink-0 mt-1" />
                      <span className=" text-[#1a5336]/70 text-sm">Mentorship and competition opportunities</span>
                    </li>
                  </ul>
                </div>

                <div>
                  <h4 className=" text-[#1a5336] mb-3">Counseling & SEL</h4>
                  <p className=" text-[#1a5336]/70 mb-3">
                  ...
                  <ul className="space-y-2">
                    <li className="flex items-start gap-2">
                      <ChevronRight className="w-4 h-4 text-[#FABA1E] flex-shrink-0 mt-1" />
                      <span className=" text-[#1a5336]/70 text-sm">Full-time school counselor for all students</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <ChevronRight className="w-4 h-4 text-[#FABA1E] flex-shrink-0 mt-1" />
                      <span className=" text-[#1a5336]/70 text-sm">Weekly SEL lessons in every classroom</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <ChevronRight className="w-4 h-4 text-[#FABA1E] flex-shrink-0 mt-1" />
                      <span className=" text-[#1a5336]/70 text-sm">Peer mediation and conflict resolution programs</span>
                    </li>
                  </ul>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
            ...
            <div className="bg-white p-8 shadow-sm">
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  <ChevronRight className="w-5 h-5 text-[#FABA1E] flex-shrink-0 mt-0.5" />
                  <span className=" text-[#1a5336]/70">All core subjects and bilingual instruction</span>
                </li>
                <li className="flex items-start gap-3">
                  <ChevronRight className="w-5 h-5 text-[#FABA1E] flex-shrink-0 mt-0.5" />
                  <span className=" text-[#1a5336]/70">Textbooks, workbooks, and learning materials</span>
                </li>
                <li className="flex items-start gap-3">
                  <ChevronRight className="w-5 h-5 text-[#FABA1E] flex-shrink-0 mt-0.5" />
                  <span className=" text-[#1a5336]/70">Art, music, PE, and library access</span>
                </li>
                <li className="flex items-start gap-3">
                  <ChevronRight className="w-5 h-5 text-[#FABA1E] flex-shrink-0 mt-0.5" />
                  <span className=" text-[#1a5336]/70">Technology devices (G3-5) and STEM equipment</span>
                </li>
                <li className="flex items-start gap-3">
                  <ChevronRight className="w-5 h-5 text-[#FABA1E] flex-shrink-0 mt-0.5" />
                  <span className=" text-[#1a5336]/70">Field trips (up to 8 per year)</span>
                </li>
                <li className="flex items-start gap-3">
                  <ChevronRight className="w-5 h-5 text-[#FABA1E] flex-shrink-0 mt-0.5" />
                  <span className=" text-[#1a5336]/70">After-school enrichment sampler sessions</span>
                </li>
                <li className="flex items-start gap-3">
                  <ChevronRight className="w-5 h-5 text-[#FABA1E] flex-shrink-0 mt-0.5" />
                  <span className=" text-[#1a5336]/70">Parent portal and digital progress reports</span>
                </li>
                <li className="flex items-start gap-3">
                  <ChevronRight className="w-5 h-5 text-[#FABA1E] flex-shrink-0 mt-0.5" />
                  <span className=" text-[#1a5336]/70">School uniform (2 sets for new students)</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white p-8 shadow-sm">
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  ...
                  <span className=" text-[#1a5336]/70">Extended care (7am–6pm)</span>
                </li>
                <li className="flex items-start gap-3">
                  <ChevronRight className="w-5 h-5 text-[#1a5336]/30 flex-shrink-0 mt-0.5" />
                  <span className=" text-[#1a5336]/70">Hot lunch program (daily or weekly)</span>
                </li>
                <li className="flex items-start gap-3">
                  <ChevronRight className="w-5 h-5 text-[#1a5336]/30 flex-shrink-0 mt-0.5" />
                  <span className=" text-[#1a5336]/70">Premium after-school clubs (sports, STEM, arts)</span>
                </li>
                <li className="flex items-start gap-3">
                  <ChevronRight className="w-5 h-5 text-[#1a5336]/30 flex-shrink-0 mt-0.5" />
                  <span className=" text-[#1a5336]/70">Additional language lessons (Mandarin, French)</span>
                </li>
                <li className="flex items-start gap-3">
                  <ChevronRight className="w-5 h-5 text-[#1a5336]/30 flex-shrink-0 mt-0.5" />
                  <span className=" text-[#1a5336]/70">Private tutoring (academic support or enrichment)</span>
                </li>
                <li className="flex items-start gap-3">
                  <ChevronRight className="w-5 h-5 text-[#1a5336]/30 flex-shrink-0 mt-0.5" />
                  <span className=" text-[#1a5336]/70">School bus transportation</span>
                </li>
                <li className="flex items-start gap-3">
                  <ChevronRight className="w-5 h-5 text-[#1a5336]/30 flex-shrink-0 mt-0.5" />
                  <span className=" text-[#1a5336]/70">Grade 5 residential camp (additional fee)</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
            <div className="bg-white p-8 border-l-4 border-[#1a5336]">
              ...
              <ul className="space-y-2">
                <li className="flex items-start gap-2">
                  <ChevronRight className="w-4 h-4 text-[#FABA1E] flex-shrink-0 mt-1" />
                  <span className=" text-[#1a5336]/70 text-sm"><strong>Annual:</strong> 5% discount for full payment upfront</span>
                </li>
                <li className="flex items-start gap-2">
                  <ChevronRight className="w-4 h-4 text-[#FABA1E] flex-shrink-0 mt-1" />
                  <span className=" text-[#1a5336]/70 text-sm"><strong>Semester:</strong> 2 installments (September & February)</span>
                </li>
                <li className="flex items-start gap-2">
                  <ChevronRight className="w-4 h-4 text-[#FABA1E] flex-shrink-0 mt-1" />
            ...
            <div className="bg-white p-8 border-l-4 border-[#1a5336]">
              <h3 className=" text-[24px] font-bold text-[#1a5336] mb-4">Scholarships & Refunds</h3>
              <p className=" text-[#1a5336]/70 mb-4">
              ...
              <ul className="space-y-2">
                <li className="flex items-start gap-2">
                  <ChevronRight className="w-4 h-4 text-[#FABA1E] flex-shrink-0 mt-1" />
                  <span className=" text-[#1a5336]/70 text-sm">Merit scholarships: 10-50% for academic excellence</span>
                </li>
                <li className="flex items-start gap-2">
                  <ChevronRight className="w-4 h-4 text-[#FABA1E] flex-shrink-0 mt-1" />
                  <span className=" text-[#1a5336]/70 text-sm">Need-based aid: Apply through financial aid office</span>
                </li>
                <li className="flex items-start gap-2">
                  <ChevronRight className="w-4 h-4 text-[#FABA1E] flex-shrink-0 mt-1" />
                  <span className=" text-[#1a5336]/70 text-sm">Sibling discount: 10% for 2nd child, 15% for 3rd+</span>
                </li>
                <li className="flex items-start gap-2">
                  <ChevronRight className="w-4 h-4 text-[#FABA1E] flex-shrink-0 mt-1" />
                  <span className=" text-[#1a5336]/70 text-sm">Withdrawal policy: Prorated refund within first semester</span>
                </li>
              </ul>
            </div>
          </div>
