...
//             <p className="text-[#FABA1E] mb-4  uppercase tracking-wider">Grades 6-12 | Ages 11-18</p>
...
//                   <div>
//                     <div className=" text-[#fffae9] text-2xl mb-1">1:12</div>
//                     <div className=" text-[#fffae9]/80 text-sm">Average Class Size</div>
//                   </div>
//                 </div>
//               </div>
//               <div className="bg-white/10 backdrop-blur-sm p-6 border border-white/20">
...
//                   <div>
//                     <div className=" text-[#fffae9] text-2xl mb-1">95%</div>
//                     <div className=" text-[#fffae9]/80 text-sm">University Acceptance</div>
//                   </div>
//                 </div>
//               </div>
//               <div className="bg-white/10 backdrop-blur-sm p-6 border border-white/20">
...
//                     <div className=" text-[#fffae9]/80 text-sm">Clubs & Activities</div>
//                   </div>
//                 </div>
//               </div>
//             </div>
...
//                 className={`pb-4 px-2  transition-colors focus:outline-none focus:ring-2 focus:ring-[#FABA1E] ${
//                   activeTab === 'lower'
...
//               {/* Left: Overview */}
//               <div>
//                 <h3 className=" text-[24px] font-bold text-[#1a5336] mb-6">Lower Secondary Overview</h3>
...
//                   <div className="bg-white p-6 border-l-4 border-[#FABA1E]">
//                     <h4 className=" text-[#1a5336] mb-2">Electives</h4>
//                     <p className=" text-[#1a5336]/70 text-sm">
...
//                   <div className="bg-white p-6 border-l-4 border-[#FABA1E]">
//                     <h4 className=" text-[#1a5336] mb-2">Learning Approach</h4>
//                     <p className=" text-[#1a5336]/70 text-sm">
...
//                           <th className="text-left py-3  text-[#1a5336]">Subject</th>
//                           <th className="text-right py-3  text-[#1a5336]">Hours/Week</th>
//                         </tr>
//                       </thead>
//                       <tbody>
//                         <tr className="border-b border-[#1a5336]/20">
//                           <td className="py-3  text-[#1a5336]/70">Language Arts (Eng + Vie)</td>
...
//                         </tr>
//                         <tr className="border-b border-[#1a5336]/20">
//                           <td className="py-3  text-[#1a5336]/70">Science</td>
...
//                         </tr>
//                         <tr className="border-b border-[#1a5336]/20">
//                           <td className="py-3  text-[#1a5336]/70">Electives</td>
//                           <td className="text-right py-3  text-[#1a5336]">5</td>
//                         </tr>
//                         <tr className="border-b border-[#1a5336]/20">
//                           <td className="py-3  text-[#1a5336]/70">PE & Wellbeing</td>
...
//                       <span className=" text-[#1a5336]/70">Continuous formative assessment</span>
//                     </li>
//                     <li className="flex items-start gap-2">
//                       <ChevronRight className="w-5 h-5 text-[#FABA1E] flex-shrink-0 mt-0.5" />
//                       <span className=" text-[#1a5336]/70">Semester exams and projects</span>
//                     </li>
//                     <li className="flex items-start gap-2">
//                       <ChevronRight className="w-5 h-5 text-[#FABA1E] flex-shrink-0 mt-0.5" />
//                       <span className=" text-[#1a5336]/70">Quarterly progress reports</span>
//                     </li>
//                   </ul>
//                 </div>
...
//               {/* Left: Overview */}
//               <div>
//                 <h3 className=" text-[24px] font-bold text-[#1a5336] mb-6">Upper Secondary Overview</h3>
                
//                 <div className="space-y-6">
//                   <div className="bg-white p-6 border-l-4 border-[#FABA1E]">
//                     <h4 className=" text-[#1a5336] mb-2">Core Requirements</h4>
//                     <p className=" text-[#1a5336]/70 text-sm">
...
//                   <div className="bg-white p-6 border-l-4 border-[#FABA1E]">
//                     <h4 className=" text-[#1a5336] mb-2">AP/IB Options</h4>
//                     <p className=" text-[#1a5336]/70 text-sm">
...
//                       <tbody>
//                         <tr className="border-b border-[#1a5336]/20">
//                           <td className="py-3  text-[#1a5336]/70">Core Subjects</td>
//                           <td className="text-right py-3  text-[#1a5336]">15</td>
//                         </tr>
//                         <tr className="border-b border-[#1a5336]/20">
...
//                         </tr>
//                         <tr className="border-b border-[#1a5336]/20">
//                           <td className="py-3  text-[#1a5336]/70">Independent Study</td>
//                           <td className="text-right py-3  text-[#1a5336]">2</td>
//                         </tr>
//                         <tr className="border-b border-[#1a5336]/20">
//                           <td className="py-3  text-[#1a5336]/70">University Prep</td>
//                           <td className="text-right py-3  text-[#1a5336]">1</td>
//                         </tr>
//                       </tbody>
//                     </table>
//                   </div>
...
//                     <li className="flex items-start gap-2">
//                       <ChevronRight className="w-5 h-5 text-[#FABA1E] flex-shrink-0 mt-0.5" />
//                       <span className=" text-[#1a5336]/70">Cumulative GPA (4.0 scale)</span>
//                     </li>
//                     <li className="flex items-start gap-2">
//                       <ChevronRight className="w-5 h-5 text-[#FABA1E] flex-shrink-0 mt-0.5" />
//                       <span className=" text-[#1a5336]/70">AP/IB exam scores for credit</span>
//                     </li>
//                     <li className="flex items-start gap-2">
//                       <ChevronRight className="w-5 h-5 text-[#FABA1E] flex-shrink-0 mt-0.5" />
//                       <span className=" text-[#1a5336]/70">Official transcripts for university applications</span>
//                     </li>
//                   </ul>
//                 </div>
...
//                   <span className=" text-[#1a5336]/70 text-sm">Robotics teams (FRC, VEX)</span>
//                 </li>
//                 <li className="flex items-start gap-2">
//                   <ChevronRight className="w-4 h-4 text-[#FABA1E] flex-shrink-0 mt-1" />
//                   <span className=" text-[#1a5336]/70 text-sm">Science Olympiad and Math competitions</span>
//                 </li>
//                 <li className="flex items-start gap-2">
//                   <ChevronRight className="w-4 h-4 text-[#FABA1E] flex-shrink-0 mt-1" />
//                   <span className=" text-[#1a5336]/70 text-sm">Coding club and hackathons</span>
//                 </li>
//               </ul>
//             </div>
...
//                 <h3 className=" text-[24px] font-bold text-[#1a5336]">Debate & Leadership</h3>
//               </div>
//               <ul className="space-y-2">
//                 <li className="flex items-start gap-2">
//                   <ChevronRight className="w-4 h-4 text-[#FABA1E] flex-shrink-0 mt-1" />
//                   <span className=" text-[#1a5336]/70 text-sm">Model UN and debate tournaments</span>
//                 </li>
//                 <li className="flex items-start gap-2">
//                   <ChevronRight className="w-4 h-4 text-[#FABA1E] flex-shrink-0 mt-1" />
//                   <span className=" text-[#1a5336]/70 text-sm">Student government and leadership council</span>
//                 </li>
//                 <li className="flex items-start gap-2">
//                   <ChevronRight className="w-4 h-4 text-[#FABA1E] flex-shrink-0 mt-1" />
//                   <span className=" text-[#1a5336]/70 text-sm">Public speaking and TEDx Youth</span>
//                 </li>
//               </ul>
//             </div>
...
//                 <h3 className=" text-[24px] font-bold text-[#1a5336]">Arts & Performance</h3>
//               </div>
//               <ul className="space-y-2">
//                 <li className="flex items-start gap-2">
//                   <ChevronRight className="w-4 h-4 text-[#FABA1E] flex-shrink-0 mt-1" />
//                   <span className=" text-[#1a5336]/70 text-sm">Theater productions and musicals</span>
//                 </li>
//                 <li className="flex items-start gap-2">
//                   <ChevronRight className="w-4 h-4 text-[#FABA1E] flex-shrink-0 mt-1" />
//                   <span className=" text-[#1a5336]/70 text-sm">Orchestra, band, and choir ensembles</span>
//                 </li>
//                 <li className="flex items-start gap-2">
//                   <ChevronRight className="w-4 h-4 text-[#FABA1E] flex-shrink-0 mt-1" />
//                   <span className=" text-[#1a5336]/70 text-sm">Visual arts exhibitions and film club</span>
//                 </li>
//               </ul>
//             </div>
...
//                 <li className="flex items-start gap-2">
//                   <ChevronRight className="w-4 h-4 text-[#FABA1E] flex-shrink-0 mt-1" />
//                   <span className=" text-[#1a5336]/70 text-sm">Basketball, soccer, volleyball, badminton</span>
//                 </li>
//                 <li className="flex items-start gap-2">
//                   <ChevronRight className="w-4 h-4 text-[#FABA1E] flex-shrink-0 mt-1" />
//                   <span className=" text-[#1a5336]/70 text-sm">Swimming, track & field, tennis</span>
//                 </li>
//                 <li className="flex items-start gap-2">
//                   <ChevronRight className="w-4 h-4 text-[#FABA1E] flex-shrink-0 mt-1" />
//                   <span className=" text-[#1a5336]/70 text-sm">Regional and national competitions</span>
//                 </li>
//               </ul>
//             </div>
...
//                 <h3 className=" text-[24px] font-bold text-[#1a5336]">Career Exploration</h3>
//               </div>
//               <ul className="space-y-2">
//                 <li className="flex items-start gap-2">
//                   <ChevronRight className="w-4 h-4 text-[#FABA1E] flex-shrink-0 mt-1" />
//                   <span className=" text-[#1a5336]/70 text-sm">Internship programs with local companies</span>
//                 </li>
//                 <li className="flex items-start gap-2">
//                   <ChevronRight className="w-4 h-4 text-[#FABA1E] flex-shrink-0 mt-1" />
//                   <span className=" text-[#1a5336]/70 text-sm">Career days and alumni mentorship</span>
//                 </li>
//                 <li className="flex items-start gap-2">
//                   <ChevronRight className="w-4 h-4 text-[#FABA1E] flex-shrink-0 mt-1" />
//                   <span className=" text-[#1a5336]/70 text-sm">Entrepreneurship club and business plan competition</span>
//                 </li>
//               </ul>
//             </div>
//           </div>
...
//                     <li className="flex items-start gap-2">
//                       <ChevronRight className="w-4 h-4 text-[#FABA1E] flex-shrink-0 mt-1" />
//                       <span className=" text-[#1a5336]/70 text-sm">Specialized support for multilingual learners</span>
//                     </li>
//                     <li className="flex items-start gap-2">
//                       <ChevronRight className="w-4 h-4 text-[#FABA1E] flex-shrink-0 mt-1" />
//                       <span className=" text-[#1a5336]/70 text-sm">Academic language development in content areas</span>
//                     </li>
//                   </ul>
//                 </div>

//                 <div>
//                   <h4 className=" text-[#1a5336] mb-3">RTI & Tutoring</h4>
//                   <ul className="space-y-2">
//                     <li className="flex items-start gap-2">
//                       <ChevronRight className="w-4 h-4 text-[#FABA1E] flex-shrink-0 mt-1" />
//                       <span className=" text-[#1a5336]/70 text-sm">Free peer and teacher tutoring sessions</span>
//                     </li>
//                     <li className="flex items-start gap-2">
//                       <ChevronRight className="w-4 h-4 text-[#FABA1E] flex-shrink-0 mt-1" />
//                       <span className=" text-[#1a5336]/70 text-sm">Study skills workshops and time management</span>
//                     </li>
//                   </ul>
//                 </div>

//                 <div>
//                   <h4 className=" text-[#1a5336] mb-3">Enrichment & Honors</h4>
//                   <ul className="space-y-2">
//                     <li className="flex items-start gap-2">
//                       <ChevronRight className="w-4 h-4 text-[#FABA1E] flex-shrink-0 mt-1" />
//                       <span className=" text-[#1a5336]/70 text-sm">Advanced placement and honors tracks</span>
//                     </li>
//                     <li className="flex items-start gap-2">
//                       <ChevronRight className="w-4 h-4 text-[#FABA1E] flex-shrink-0 mt-1" />
//                       <span className=" text-[#1a5336]/70 text-sm">Independent research and mentorship programs</span>
//                     </li>
//                   </ul>
//                 </div>
//               </div>
...
//                     <li className="flex items-start gap-2">
//                       <ChevronRight className="w-4 h-4 text-[#FABA1E] flex-shrink-0 mt-1" />
//                       <span className=" text-[#1a5336]/70 text-sm">Full-time counselors for mental health support</span>
//                     </li>
//                     <li className="flex items-start gap-2">
//                       <ChevronRight className="w-4 h-4 text-[#FABA1E] flex-shrink-0 mt-1" />
//                       <span className=" text-[#1a5336]/70 text-sm">Stress management and mindfulness programs</span>
//                     </li>
//                     <li className="flex items-start gap-2">
//                       <ChevronRight className="w-4 h-4 text-[#FABA1E] flex-shrink-0 mt-1" />
//                       <span className=" text-[#1a5336]/70 text-sm">Peer support groups and crisis intervention</span>
//                     </li>
//                   </ul>
//                 </div>

//                 <div>
//                   <h4 className=" text-[#1a5336] mb-3">University Preparation</h4>
//                   <ul className="space-y-2">
//                     <li className="flex items-start gap-2">
//                       <ChevronRight className="w-4 h-4 text-[#FABA1E] flex-shrink-0 mt-1" />
//                       <span className=" text-[#1a5336]/70 text-sm">Individual university counseling from Grade 10</span>
//                     </li>
//                     <li className="flex items-start gap-2">
//                       <ChevronRight className="w-4 h-4 text-[#FABA1E] flex-shrink-0 mt-1" />
//                       <span className=" text-[#1a5336]/70 text-sm">SAT/ACT prep courses and practice tests</span>
//                     </li>
//                     <li className="flex items-start gap-2">
//                       <ChevronRight className="w-4 h-4 text-[#FABA1E] flex-shrink-0 mt-1" />
//                       <span className=" text-[#1a5336]/70 text-sm">Essay workshops and application support</span>
//                     </li>
//                     <li className="flex items-start gap-2">
//                       <ChevronRight className="w-4 h-4 text-[#FABA1E] flex-shrink-0 mt-1" />
//                       <span className=" text-[#1a5336]/70 text-sm">University fairs and campus visit coordination</span>
//                     </li>
//                   </ul>
//                 </div>
//               </div>
...
//                 <li className="flex items-start gap-3">
//                   <ChevronRight className="w-5 h-5 text-[#FABA1E] flex-shrink-0 mt-0.5" />
//                   <span className=" text-[#1a5336]/70">All core and specialized track courses</span>
//                 </li>
//                 <li className="flex items-start gap-3">
//                   <ChevronRight className="w-5 h-5 text-[#FABA1E] flex-shrink-0 mt-0.5" />
//                   <span className=" text-[#1a5336]/70">Textbooks, lab materials, and technology devices</span>
//                 </li>
//                 <li className="flex items-start gap-3">
//                   <ChevronRight className="w-5 h-5 text-[#FABA1E] flex-shrink-0 mt-0.5" />
//                   <span className=" text-[#1a5336]/70">University counseling and application support</span>
//                 </li>
//                 <li className="flex items-start gap-3">
//                   <ChevronRight className="w-5 h-5 text-[#FABA1E] flex-shrink-0 mt-0.5" />
//                   <span className=" text-[#1a5336]/70">Access to all school facilities and equipment</span>
//                 </li>
//                 <li className="flex items-start gap-3">
//                   <ChevronRight className="w-5 h-5 text-[#FABA1E] flex-shrink-0 mt-0.5" />
//                   <span className=" text-[#1a5336]/70">Participation in clubs and most activities</span>
//                 </li>
//                 <li className="flex items-start gap-3">
//                   <ChevronRight className="w-5 h-5 text-[#FABA1E] flex-shrink-0 mt-0.5" />
//                   <span className=" text-[#1a5336]/70">Academic support and tutoring services</span>
//                 </li>
//                 <li className="flex items-start gap-3">
//                   <ChevronRight className="w-5 h-5 text-[#FABA1E] flex-shrink-0 mt-0.5" />
...
//                 <li className="flex items-start gap-3">
//                   <ChevronRight className="w-5 h-5 text-[#1a5336]/30 flex-shrink-0 mt-0.5" />
//                   <span className=" text-[#1a5336]/70">SAT/ACT test prep intensive courses</span>
//                 </li>
//                 <li className="flex items-start gap-3">
//                   <ChevronRight className="w-5 h-5 text-[#1a5336]/30 flex-shrink-0 mt-0.5" />
//                   <span className=" text-[#1a5336]/70">Premium sports teams and travel costs</span>
//                 </li>
//                 <li className="flex items-start gap-3">
//                   <ChevronRight className="w-5 h-5 text-[#1a5336]/30 flex-shrink-0 mt-0.5" />
//                   <span className=" text-[#1a5336]/70">Study abroad and exchange programs</span>
//                 </li>
//                 <li className="flex items-start gap-3">
//                   <ChevronRight className="w-5 h-5 text-[#1a5336]/30 flex-shrink-0 mt-0.5" />
//                   <span className=" text-[#1a5336]/70">Private music lessons and art portfolio prep</span>
//                 </li>
//                 <li className="flex items-start gap-3">
//                   <ChevronRight className="w-5 h-5 text-[#1a5336]/30 flex-shrink-0 mt-0.5" />
//                   <span className=" text-[#1a5336]/70">Extended care and transportation</span>
//                 </li>
//               </ul>
//             </div>
//           </div>
...
//                 <li className="flex items-start gap-2">
//                   <ChevronRight className="w-4 h-4 text-[#FABA1E] flex-shrink-0 mt-1" />
//                   <span className=" text-[#1a5336]/70 text-sm"><strong>Semester:</strong> 2 installments per year</span>
//                 </li>
//                 <li className="flex items-start gap-2">
//                   <ChevronRight className="w-4 h-4 text-[#FABA1E] flex-shrink-0 mt-1" />
...
//                 <li className="flex items-start gap-2">
//                   <ChevronRight className="w-4 h-4 text-[#FABA1E] flex-shrink-0 mt-1" />
//                   <span className=" text-[#1a5336]/70 text-sm">Academic merit scholarships: 20-100%</span>
//                 </li>
//                 <li className="flex items-start gap-2">
//                   <ChevronRight className="w-4 h-4 text-[#FABA1E] flex-shrink-0 mt-1" />
//                   <span className=" text-[#1a5336]/70 text-sm">Talent scholarships in STEM, arts, athletics</span>
//                 </li>
//                 <li className="flex items-start gap-2">
//                   <ChevronRight className="w-4 h-4 text-[#FABA1E] flex-shrink-0 mt-1" />
//                   <span className=" text-[#1a5336]/70 text-sm">Need-based financial aid available</span>
//                 </li>
//                 <li className="flex items-start gap-2">
//                   <ChevronRight className="w-4 h-4 text-[#FABA1E] flex-shrink-0 mt-1" />
//                   <span className=" text-[#1a5336]/70 text-sm">Sibling discount: 10% (2nd), 15% (3rd+)</span>
//                 </li>
//               </ul>
//             </div>
//           </div>
