  ...
  return (
    ...
    >
      <div className="grid md:grid-cols-2 gap-12 mb-16">
        <div>
          <h2 className="font-['Crimson_Pro'] text-[32px] md:text-[40px] text-[#1a5336] mb-6">Parent Portal</h2>
        ...
        <div>
          <h2 className="font-['Crimson_Pro'] text-[32px] md:text-[40px] text-[#1a5336] mb-6">Parent Resources</h2>
      ...
      <div className="bg-white p-8 md:p-12 mb-16">
        <h2 className="font-['Crimson_Pro'] text-[32px] md:text-[40px] text-[#1a5336] mb-6">Parent Community</h2>
        <p className="font-['Lexend_Deca'] text-[#666] leading-relaxed mb-6">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="p-6 bg-[#fffae9]">
            <h3 className="font-['Crimson_Pro'] text-[24px] text-[#1a5336] mb-3">Parent Workshops</h3>
            <p className="font-['Lexend_Deca'] text-[#666] text-sm">
              Regular workshops on parenting, child development, and supporting your child's education.
            </p>
          </div>
          <div className="p-6 bg-[#fffae9]">
            <h3 className="font-['Crimson_Pro'] text-[24px] text-[#1a5336] mb-3">School Events</h3>
            <p className="font-['Lexend_Deca'] text-[#666] text-sm">
              Participate in school performances, sports days, cultural celebrations, and family activities.
            </p>
          </div>
          <div className="p-6 bg-[#fffae9]">
            <h3 className="font-['Crimson_Pro'] text-[24px] text-[#1a5336] mb-3">Support Network</h3>
            <p className="font-['Lexend_Deca'] text-[#666] text-sm">
