...
import founderImage from '@assets/images/home-page/Section-Nutrion.png';
      ...
      <div className="relative z-20 w-full max-w-7xl mx-auto px-4 lg:px-8">
        <div className="grid md:grid-cols-5 gap-8 lg:gap-12 items-center">
          ...
          >
            ...
            {/* Title */}
            <h2 className="font-black uppercase text-2xl md:text-3xl lg:text-4xl text-white mb-6 leading-tight">
            ...
            <p className="font-medium text-base md:text-lg text-white/90 mb-6 leading-relaxed">
             ...
             {/* List */}
            <ul className="text-white font-medium text-sm md:text-base mb-8 space-y-2">
              <li>1. Safe Environment</li>
              <li>2. Holistic Growth</li>
              <li>3. Quality Teaching</li>
              <li>4. Individual Care</li>
            </ul>
            {/* Read More Link */}
            <div>
              <button
